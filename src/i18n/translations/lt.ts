...
export const lt: TranslationDictionary = {
  ...
  courses: {
    ...
    locationSaved:
      "Rodomi aikštynai netoli jūsų išsaugotos numatytosios vietos.",
  ...
  sunTimes: {
    ...
    playableLight:
      "Žaidimui tinkama šviesa (civilinė prieblanda): {dawn} – {dusk}",
  },
  weatherSummary: {
    loadingForecast: "Kraunama prognozė…",
  ...
  playability: {
    ...
    reasons: {
      ...
      cold: "šalta",
      windy: "vėjuota",
      gusty: "gūsingas vėjas",
      blustery: "smarkus vėjas",
      gale: "vėtra",
    },
  },
  format: {
  ...
  favorites: {
    title: "Mėgstami",
    empty:
      "Kol kas nėra mėgstamų. Pridėkite aikštynus prie mėgstamų su žvaigždute.",
  ...
  bookmarks: {
    ...
    empty:
      "Kol kas nėra starto laikų. Pridėkite aikštyną ir laiką su starto laiko mygtuku.",
