...
export const no: TranslationDictionary = {
  ...
  courses: {
    ...
    subtitleWeather: "Baner med best spilleforhold akkurat nå, nærmest først.",
    subtitleCombined: "Balanserer avstand og nåværende forhold, nærmest først.",
    locationDenied:
  ...
  bookmarks: {
    ...
    empty:
      "Ingen starttider ennå. Legg til en bane og et tidspunkt med starttidsknappen.",
