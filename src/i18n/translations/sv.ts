...
export const sv: TranslationDictionary = {
  ...
  courses: {
    ...
    subtitleWeather: "Banor med bäst spelförhållanden just nu, närmast först.",
    subtitleCombined:
    ...
    locationLoading: "Söker din plats — visar banor nära Kuopio tills vidare.",
  ...
  bookmarks: {
    ...
    empty:
      "Inga starttider än. Lägg till en bana och tid med starttidsknappen.",
