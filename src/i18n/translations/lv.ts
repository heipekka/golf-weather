...
export const lv: TranslationDictionary = {
  ...
  courses: {
    ...
    locationSaved:
      "Tiek rādīti laukumi netālu no jūsu saglabātās noklusējuma atrašanās vietas.",
  ...
  settings: {
    ...
    location: {
      ...
      notSet:
        "Noklusējuma atrašanās vieta nav iestatīta — tiek izmantots Kuopio.",
  ...
  favorites: {
    title: "Izlase",
    empty:
      "Izlasē vēl nav laukumu. Pievienojiet laukumus izlasei ar zvaigznīti.",
  ...
  bookmarks: {
    ...
    empty:
      "Starta laiku vēl nav. Pievienojiet laukumu un laiku ar starta laika pogu.",
